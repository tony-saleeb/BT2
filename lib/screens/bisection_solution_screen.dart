...
class BisectionSolutionScreen extends StatefulWidget {
  final List<BisectionResult> results;
  final String function;
  final int decimalPlaces;

  const BisectionSolutionScreen({
    super.key,
  ...
  @override
  State<BisectionSolutionScreen> createState() =>
      _BisectionSolutionScreenState();
}

class _BisectionSolutionScreenState extends State<BisectionSolutionScreen>
    with TickerProviderStateMixin {
  late TabController _tabController;
  final _tabScrollController = ScrollController();
  final _tableScrollController = ScrollController();
  int _currentTabIndex = 0;
  bool _shouldRound = true; // Default to rounded values
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'The Bisection Method finds roots by repeatedly dividing an interval in half. It requires that the function changes sign at the interval endpoints, guaranteeing at least one root in the interval.',
                                  style: TextStyle(
                                    color: colorScheme.onSurfaceVariant,
                                    fontSize: isSmallScreen ? 14.sp : 16.sp,
                                    height: 1.6,
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Expanded(
                                        child: Text(
                                          'Requires opposite signs at interval bounds',
                                          style: TextStyle(
                                            color: colorScheme.secondary,
  ...
  String _buildErrorReduction() {
    ...
    BisectionResult? firstWithError;
