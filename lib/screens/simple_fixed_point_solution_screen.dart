...
class SimpleFixedPointSolutionScreen extends StatefulWidget {
  final List<SimpleFixedPointResult> results;
  final String function;
  final int decimalPlaces;

  const SimpleFixedPointSolutionScreen({
    super.key,
  ...
  @override
  State<SimpleFixedPointSolutionScreen> createState() => _SimpleFixedPointSolutionScreenState();
}

class _SimpleFixedPointSolutionScreenState extends State<SimpleFixedPointSolutionScreen> with TickerProviderStateMixin {
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'The Simple Fixed Point Method iteratively finds a solution where g(x) = x. The method converges when successive iterations approach a fixed point, indicating we\'ve found a root of the equation.',
                                  style: TextStyle(
                                    color: colorScheme.onSurfaceVariant,
                                    fontSize: isSmallScreen ? 14.sp : 16.sp,
                                    height: 1.6,
            ...
            children: [
              ...
              ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return _buildDebugStep(context, result, index);
                },
              ),
            ],
          ),
  ...
  Widget _buildDebugStep(BuildContext context, SimpleFixedPointResult result, int index) {
    final colorScheme = Theme.of(context).colorScheme;
    final xiPlus1 = result.fxi;
    final size = MediaQuery.of(context).size;
    final isSmallScreen = size.width < 600;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          ...result.debugSteps.entries.map((entry) => _buildDebugCalculation(
            context,
            entry.key,
            entry.value,
            isSmallScreen,
          ...
          if (result.ea != null && result.iteration > 1)
            _buildDebugCalculation(
              context,
              'Error calculation',
              'ε% = |${_formatNumber(xiPlus1)} - ${_formatNumber(result.xi)}| ÷ |${_formatNumber(xiPlus1)}| × 100 = ${_formatNumber(result.ea!)}%',
              isSmallScreen,
            ),
        ],
      ),
  ...
  Widget _buildDebugCalculation(BuildContext context, String label, String calculation, bool isSmallScreen) {
    final colorScheme = Theme.of(context).colorScheme;
  ...
  DataColumn _buildColumnHeader(String text, IconData icon, bool isSmallScreen, ColorScheme colorScheme) {
    return DataColumn(
      label: SizedBox(
                      ...
                      SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            SizedBox(width: 16.w),
                            Text(
                              lastResult.ea != null ? '${_formatNumber(lastResult.ea!)}%' : '--',
                              style: GoogleFonts.robotoMono(
                                fontSize: isSmallScreen ? 18.sp : 20.sp,
                                color: colorScheme.tertiary,
                                fontWeight: FontWeight.w600,
                ...
                child: IntrinsicWidth(
                  child: Column(
                    ...
                    children: [
                      Container(
                        padding: EdgeInsets.all(isSmallScreen ? 20.w : 24.w),
                        margin: EdgeInsets.symmetric(horizontal: isSmallScreen ? 16.w : 24.w),
                        width: double.infinity,
                        decoration: BoxDecoration(
                          gradient: LinearGradient(
                            begin: Alignment.topLeft,
  ...
  String _buildErrorReduction() {
    ...
    SimpleFixedPointResult? firstWithError;
